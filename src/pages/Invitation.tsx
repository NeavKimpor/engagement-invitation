    ...
    return (
        <div>
            <div className="bgr-name pt-8 pb-8">
                ...
                <div className="info flex justify-between items-center gap-4 flex-wrap pb-4">
            ...
            <div className="fam-info pt-8 pb-8">
                ...
                <div className="parents flex justify-between items-centers gap4 flex-wrap pt-8 pb-8">
